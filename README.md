...
Calculates profit or loss per trade
Displays overall profit/loss summary
Simple command-line interface
Beginner-friendly Python logic
Use Cases:
Learning Python fundamentals
Practicing financial calculations
Tracking simple stock trades
Future Improvements:
Export results to CSV/Excel
Add graphical visualization
Build a GUI version

This project is ideal for students and beginners looking to combine programming with basic financial analysis.”**
